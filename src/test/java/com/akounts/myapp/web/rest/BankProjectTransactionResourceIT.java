...
class BankProjectTransactionResourceIT {
        ...
        restBankProjectTransactionMockMvc
            .perform(
                post(ENTITY_API_URL)
                    ...
                    .content(TestUtil.convertObjectToJsonBytes(bankProjectTransaction))
            )
    ...
    void putNewBankProjectTransaction() throws Exception {
        ...
        restBankProjectTransactionMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedBankProjectTransaction.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(updatedBankProjectTransaction))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingBankProjectTransaction() throws Exception {
        ...
        restBankProjectTransactionMockMvc
            .perform(
                put(ENTITY_API_URL_ID, bankProjectTransaction.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(bankProjectTransaction))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchNonExistingBankProjectTransaction() throws Exception {
        ...
        restBankProjectTransactionMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, bankProjectTransaction.getId())
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(bankProjectTransaction))
            )
            .andExpect(status().isBadRequest());
