...
class BankStreamResourceIT {
    ...
    void createBankStream() throws Exception {
        ...
        restBankStreamMockMvc
            .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(bankStream)))
    ...
    void putNewBankStream() throws Exception {
        ...
        restBankStreamMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedBankStream.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(updatedBankStream))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingBankStream() throws Exception {
        ...
        restBankStreamMockMvc
            .perform(
                put(ENTITY_API_URL_ID, bankStream.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(bankStream))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamBankStream() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restBankStreamMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(bankStream)))
    ...
    void patchNonExistingBankStream() throws Exception {
        ...
        restBankStreamMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, bankStream.getId())
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(bankStream))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamBankStream() throws Exception {
        ...
        restBankStreamMockMvc
            .perform(
                patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(TestUtil.convertObjectToJsonBytes(bankStream))
            )
            .andExpect(status().isMethodNotAllowed());
