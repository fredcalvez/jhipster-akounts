...
class AkountsSettingsResourceIT {
    ...
    void createAkountsSettings() throws Exception {
        ...
        restAkountsSettingsMockMvc
            .perform(
                post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(akountsSettings))
            )
    ...
    void putNewAkountsSettings() throws Exception {
        ...
        restAkountsSettingsMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedAkountsSettings.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(updatedAkountsSettings))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingAkountsSettings() throws Exception {
        ...
        restAkountsSettingsMockMvc
            .perform(
                put(ENTITY_API_URL_ID, akountsSettings.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(akountsSettings))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamAkountsSettings() throws Exception {
        ...
        restAkountsSettingsMockMvc
            .perform(
                put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(akountsSettings))
            )
    ...
    void patchNonExistingAkountsSettings() throws Exception {
        ...
        restAkountsSettingsMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, akountsSettings.getId())
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(akountsSettings))
            )
            .andExpect(status().isBadRequest());
