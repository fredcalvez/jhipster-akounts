...
class BankInstitutionResourceIT {
    ...
    void createBankInstitution() throws Exception {
        ...
        restBankInstitutionMockMvc
            .perform(
                post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(bankInstitution))
            )
    ...
    void putNewBankInstitution() throws Exception {
        ...
        restBankInstitutionMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedBankInstitution.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(updatedBankInstitution))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingBankInstitution() throws Exception {
        ...
        restBankInstitutionMockMvc
            .perform(
                put(ENTITY_API_URL_ID, bankInstitution.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(bankInstitution))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamBankInstitution() throws Exception {
        ...
        restBankInstitutionMockMvc
            .perform(
                put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(bankInstitution))
            )
    ...
    void patchNonExistingBankInstitution() throws Exception {
        ...
        restBankInstitutionMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, bankInstitution.getId())
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(bankInstitution))
            )
            .andExpect(status().isBadRequest());
