...
public class BankAccountInterest implements Serializable {
    ...
    private BankAccount creditedAccountId;
    ...
    public BankAccount getCreditedAccountId() {
        return this.creditedAccountId;
    }

    public void setCreditedAccountId(BankAccount bankAccount) {
        this.creditedAccountId = bankAccount;
    }

    public BankAccountInterest creditedAccountId(BankAccount bankAccount) {
        this.setCreditedAccountId(bankAccount);
        return this;
    }
