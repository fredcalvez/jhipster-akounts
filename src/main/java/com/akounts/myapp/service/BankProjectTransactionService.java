...
public class BankProjectTransactionService {
    ...
    public Page<BankProjectTransactionDTO> findAll(Pageable pageable) {
        log.debug("Request to get all BankProjectTransactions");
        return bankProjectTransactionRepository.findAll(pageable).map(bankProjectTransactionMapper::toDto);
    }
