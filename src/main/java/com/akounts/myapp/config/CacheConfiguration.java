package com.akounts.myapp.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.akounts.myapp.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.akounts.myapp.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            ...
            createCache(cm, com.akounts.myapp.domain.PlaidAccount.class.getName());
            createCache(cm, com.akounts.myapp.domain.PlaidConfiguration.class.getName());
            createCache(cm, com.akounts.myapp.domain.PlaidItem.class.getName());
            createCache(cm, com.akounts.myapp.domain.PlaidRun.class.getName());
            createCache(cm, com.akounts.myapp.domain.PlaidTransaction.class.getName());
            createCache(cm, com.akounts.myapp.domain.ProcessRun.class.getName());
            createCache(cm, com.akounts.myapp.domain.TextCleaner.class.getName());
            createCache(cm, com.akounts.myapp.domain.TransactionDuplicates.class.getName());
            createCache(cm, com.akounts.myapp.domain.TriggerRun.class.getName());
