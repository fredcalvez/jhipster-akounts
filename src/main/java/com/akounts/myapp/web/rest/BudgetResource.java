...
import com.akounts.myapp.service.BudgetService;
...
/**
 * REST controller for managing {@link com.akounts.myapp.domain.Budget}.
 */
@RestController
@RequestMapping("/api")
public class BudgetResource {
     ...
     */
    @GetMapping("/budgets")
    public ResponseEntity<List<BudgetDTO>> getAllBudgets(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
