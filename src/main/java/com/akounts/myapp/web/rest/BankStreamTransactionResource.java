...
public class BankStreamTransactionResource {
    ...
    public ResponseEntity<List<BankStreamTransactionDTO>> getAllBankStreamTransactions(
        @org.springdoc.api.annotations.ParameterObject Pageable pageable
    ) {
        log.debug("REST request to get a page of BankStreamTransactions");
        Page<BankStreamTransactionDTO> page = bankStreamTransactionService.findAll(pageable);
