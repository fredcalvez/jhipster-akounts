...
public class AutomatchResource {
    ...
    public ResponseEntity<List<AutomatchDTO>> getAllAutomatches(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
        log.debug("REST request to get a page of Automatches");
        Page<AutomatchDTO> page = automatchService.findAll(pageable);
