...
public class BankAccountInterestResource {
    ...
    public ResponseEntity<List<BankAccountInterestDTO>> getAllBankAccountInterests(
        @org.springdoc.api.annotations.ParameterObject Pageable pageable
    ) {
        log.debug("REST request to get a page of BankAccountInterests");
        Page<BankAccountInterestDTO> page = bankAccountInterestService.findAll(pageable);
