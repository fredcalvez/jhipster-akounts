...
public class BankStreamResource {
    ...
    public ResponseEntity<List<BankStreamDTO>> getAllBankStreams(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
        log.debug("REST request to get a page of BankStreams");
        Page<BankStreamDTO> page = bankStreamService.findAll(pageable);
