...
public class BankProjectResource {
    ...
    public ResponseEntity<List<BankProjectDTO>> getAllBankProjects(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
        log.debug("REST request to get a page of BankProjects");
        Page<BankProjectDTO> page = bankProjectService.findAll(pageable);
