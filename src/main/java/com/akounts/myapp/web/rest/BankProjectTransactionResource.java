...
public class BankProjectTransactionResource {
    ...
    public ResponseEntity<List<BankProjectTransactionDTO>> getAllBankProjectTransactions(
        @org.springdoc.api.annotations.ParameterObject Pageable pageable
    ) {
        log.debug("REST request to get a page of BankProjectTransactions");
        Page<BankProjectTransactionDTO> page = bankProjectTransactionService.findAll(pageable);
