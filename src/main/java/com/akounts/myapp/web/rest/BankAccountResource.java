...
/**
 * REST controller for managing {@link com.akounts.myapp.domain.BankAccount}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<BankAccount> partialUpdateBankAccount(
        ...
        Optional<BankAccount> result = bankAccountRepository
            ...
            .map(existingBankAccount -> {
                if (bankAccount.getAccountLabel() != null) {
                    existingBankAccount.setAccountLabel(bankAccount.getAccountLabel());
                }
                ...
                if (bankAccount.getInitialAmount() != null) {
                    existingBankAccount.setInitialAmount(bankAccount.getInitialAmount());
                }
                if (bankAccount.getInitialAmountLocal() != null) {
                    existingBankAccount.setInitialAmountLocal(bankAccount.getInitialAmountLocal());
                }
                ...
                if (bankAccount.getInterest() != null) {
                    existingBankAccount.setInterest(bankAccount.getInterest());
                }
                if (bankAccount.getNickname() != null) {
                    existingBankAccount.setNickname(bankAccount.getNickname());
                }
