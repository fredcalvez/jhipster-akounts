...
public class BankSavingResource {
    ...
    public ResponseEntity<List<BankSavingDTO>> getAllBankSavings(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
        log.debug("REST request to get a page of BankSavings");
        Page<BankSavingDTO> page = bankSavingService.findAll(pageable);
