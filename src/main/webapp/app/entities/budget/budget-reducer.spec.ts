...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './budget.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BUDGET_LIST actions', async () => {
    ...
    it('dispatches FETCH_BUDGET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BUDGET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BUDGET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BUDGET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BUDGET actions', async () => {
      const expectedActions = [
        {
