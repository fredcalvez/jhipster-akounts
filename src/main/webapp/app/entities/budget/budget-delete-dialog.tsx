...
export const BudgetDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="akountsApp.budget.delete.question">
        <Translate contentKey="akountsApp.budget.delete.question" interpolate={{ id: budgetEntity.id }}>
