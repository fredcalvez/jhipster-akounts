...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BANKVENDOR_LIST actions', async () => {
    ...
    it('dispatches FETCH_BANKVENDOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BANKVENDOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BANKVENDOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BANKVENDOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BANKVENDOR actions', async () => {
      const expectedActions = [
        {
