...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TEXTCLEANER_LIST actions', async () => {
    ...
    it('dispatches FETCH_TEXTCLEANER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TEXTCLEANER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TEXTCLEANER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TEXTCLEANER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TEXTCLEANER actions', async () => {
      const expectedActions = [
        {
