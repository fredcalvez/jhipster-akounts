...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BRIDGEUSER_LIST actions', async () => {
    ...
    it('dispatches FETCH_BRIDGEUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BRIDGEUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BRIDGEUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BRIDGEUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BRIDGEUSER actions', async () => {
      const expectedActions = [
        {
