...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRIGGERRUN_LIST actions', async () => {
    ...
    it('dispatches FETCH_TRIGGERRUN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TRIGGERRUN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TRIGGERRUN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TRIGGERRUN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TRIGGERRUN actions', async () => {
      const expectedActions = [
        {
