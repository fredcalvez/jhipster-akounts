...
import { getEntities, reset } from './bank-project-transaction.reducer';
...
export const BankProjectTransaction = (props: RouteComponentProps<{ url: string }>) => {
  ...
  const totalItems = useAppSelector(state => state.bankProjectTransaction.totalItems);
  const links = useAppSelector(state => state.bankProjectTransaction.links);
  const entity = useAppSelector(state => state.bankProjectTransaction.entity);
  ...
  return (
    <div>
      ...
      <div className="table-responsive">
        <InfiniteScroll
          dataLength={bankProjectTransactionList ? bankProjectTransactionList.length : 0}
          next={handleLoadMore}
              ...
              <thead>
                <tr>
                  <th className="hand" onClick={sort('id')}>
                    <Translate contentKey="akountsApp.bankProjectTransaction.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
