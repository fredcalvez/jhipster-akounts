...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './bank-project-transaction.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BANKPROJECTTRANSACTION_LIST actions', async () => {
    ...
    it('dispatches FETCH_BANKPROJECTTRANSACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BANKPROJECTTRANSACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BANKPROJECTTRANSACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BANKPROJECTTRANSACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BANKPROJECTTRANSACTION actions', async () => {
      const expectedActions = [
        {
