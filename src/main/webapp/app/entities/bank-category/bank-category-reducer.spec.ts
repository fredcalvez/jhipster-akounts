...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BANKCATEGORY_LIST actions', async () => {
    ...
    it('dispatches FETCH_BANKCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BANKCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BANKCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BANKCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BANKCATEGORY actions', async () => {
      const expectedActions = [
        {
