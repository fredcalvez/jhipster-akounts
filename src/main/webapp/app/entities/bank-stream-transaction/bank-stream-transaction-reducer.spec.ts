...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './bank-stream-transaction.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BANKSTREAMTRANSACTION_LIST actions', async () => {
    ...
    it('dispatches FETCH_BANKSTREAMTRANSACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BANKSTREAMTRANSACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BANKSTREAMTRANSACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BANKSTREAMTRANSACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BANKSTREAMTRANSACTION actions', async () => {
      const expectedActions = [
        {
