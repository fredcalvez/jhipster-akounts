...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './bank-account-interest.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BANKACCOUNTINTEREST_LIST actions', async () => {
    ...
    it('dispatches FETCH_BANKACCOUNTINTEREST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BANKACCOUNTINTEREST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BANKACCOUNTINTEREST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BANKACCOUNTINTEREST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BANKACCOUNTINTEREST actions', async () => {
      const expectedActions = [
        {
