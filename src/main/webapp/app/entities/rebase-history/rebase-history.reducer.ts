...
export const createEntity = createAsyncThunk(
  ...
  async (entity: IRebaseHistory, thunkAPI) => {
    const result = await axios.post<IRebaseHistory>(apiUrl, cleanEntity(entity));
...
export const updateEntity = createAsyncThunk(
  ...
  async (entity: IRebaseHistory, thunkAPI) => {
    const result = await axios.put<IRebaseHistory>(`${apiUrl}/${entity.id}`, cleanEntity(entity));
    thunkAPI.dispatch(getEntities({}));
    return result;
  },
  { serializeError: serializeAxiosError }
...
export const partialUpdateEntity = createAsyncThunk(
  ...
  async (entity: IRebaseHistory, thunkAPI) => {
    const result = await axios.patch<IRebaseHistory>(`${apiUrl}/${entity.id}`, cleanEntity(entity));
    thunkAPI.dispatch(getEntities({}));
    return result;
  },
  { serializeError: serializeAxiosError }
...
export const deleteEntity = createAsyncThunk(
  ...
  async (id: string | number, thunkAPI) => {
    const requestUrl = `${apiUrl}/${id}`;
    const result = await axios.delete<IRebaseHistory>(requestUrl);
    thunkAPI.dispatch(getEntities({}));
    return result;
  },
  { serializeError: serializeAxiosError }
