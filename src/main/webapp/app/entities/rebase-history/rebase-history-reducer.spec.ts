...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REBASEHISTORY_LIST actions', async () => {
    ...
    it('dispatches FETCH_REBASEHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REBASEHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REBASEHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REBASEHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REBASEHISTORY actions', async () => {
      const expectedActions = [
        {
