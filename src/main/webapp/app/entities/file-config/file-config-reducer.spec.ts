...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FILECONFIG_LIST actions', async () => {
    ...
    it('dispatches FETCH_FILECONFIG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FILECONFIG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FILECONFIG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FILECONFIG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FILECONFIG actions', async () => {
      const expectedActions = [
        {
