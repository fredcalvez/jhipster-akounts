...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BRIDGEACCOUNT_LIST actions', async () => {
    ...
    it('dispatches FETCH_BRIDGEACCOUNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BRIDGEACCOUNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BRIDGEACCOUNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BRIDGEACCOUNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BRIDGEACCOUNT actions', async () => {
      const expectedActions = [
        {
