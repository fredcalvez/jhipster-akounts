...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BRIDGERUN_LIST actions', async () => {
    ...
    it('dispatches FETCH_BRIDGERUN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BRIDGERUN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BRIDGERUN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BRIDGERUN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BRIDGERUN actions', async () => {
      const expectedActions = [
        {
