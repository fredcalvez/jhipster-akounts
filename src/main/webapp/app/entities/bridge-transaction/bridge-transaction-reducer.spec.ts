...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './bridge-transaction.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BRIDGETRANSACTION_LIST actions', async () => {
    ...
    it('dispatches FETCH_BRIDGETRANSACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BRIDGETRANSACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BRIDGETRANSACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BRIDGETRANSACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BRIDGETRANSACTION actions', async () => {
      const expectedActions = [
        {
