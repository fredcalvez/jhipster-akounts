...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './plaid-transaction.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PLAIDTRANSACTION_LIST actions', async () => {
    ...
    it('dispatches FETCH_PLAIDTRANSACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PLAIDTRANSACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PLAIDTRANSACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PLAIDTRANSACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PLAIDTRANSACTION actions', async () => {
      const expectedActions = [
        {
