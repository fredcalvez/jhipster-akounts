...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './plaid.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PLAID_LIST actions', async () => {
    ...
    it('dispatches FETCH_PLAID actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PLAID actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PLAID actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PLAID actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PLAID actions', async () => {
      const expectedActions = [
        {
