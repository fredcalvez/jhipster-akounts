...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FILEIMPORT_LIST actions', async () => {
    ...
    it('dispatches FETCH_FILEIMPORT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FILEIMPORT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FILEIMPORT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FILEIMPORT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FILEIMPORT actions', async () => {
      const expectedActions = [
        {
