...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PLAIDACCOUNT_LIST actions', async () => {
    ...
    it('dispatches FETCH_PLAIDACCOUNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PLAIDACCOUNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PLAIDACCOUNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PLAIDACCOUNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PLAIDACCOUNT actions', async () => {
      const expectedActions = [
        {
