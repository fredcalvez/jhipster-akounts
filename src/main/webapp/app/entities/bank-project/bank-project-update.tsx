...
export const BankProjectUpdate = (props: RouteComponentProps<{ id: string }>) => {
  ...
  const saveEntity = values => {
    const entity = {
      ...bankProjectEntity,
      ...values,
      mainAccountId: bankAccounts.find(it => it.id.toString() === values.mainAccountId.toString()),
    };
  ...
  const defaultValues = () =>
    isNew
      ...
      : {
          ...bankProjectEntity,
          mainAccountId: bankProjectEntity?.mainAccountId?.id,
        };
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              />
              <ValidatedField
                id="bank-project-mainAccountId"
                name="mainAccountId"
                data-cy="mainAccountId"
                label={translate('akountsApp.bankProject.mainAccountId')}
                type="select"
              >
                <option value="" key="0" />
                {bankAccounts
