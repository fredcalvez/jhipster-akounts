...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BANKPROJECT_LIST actions', async () => {
    ...
    it('dispatches FETCH_BANKPROJECT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BANKPROJECT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BANKPROJECT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BANKPROJECT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BANKPROJECT actions', async () => {
      const expectedActions = [
        {
