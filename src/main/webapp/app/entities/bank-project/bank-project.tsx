...
import { getEntities, reset } from './bank-project.reducer';
...
export const BankProject = (props: RouteComponentProps<{ url: string }>) => {
  ...
  const totalItems = useAppSelector(state => state.bankProject.totalItems);
  const links = useAppSelector(state => state.bankProject.links);
  const entity = useAppSelector(state => state.bankProject.entity);
  ...
  return (
    <div>
      ...
      <div className="table-responsive">
        <InfiniteScroll
          dataLength={bankProjectList ? bankProjectList.length : 0}
          next={handleLoadMore}
              ...
              <thead>
                <tr>
                  <th className="hand" onClick={sort('id')}>
                    <Translate contentKey="akountsApp.bankProject.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('name')}>
                    <Translate contentKey="akountsApp.bankProject.name">Name</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('projectType')}>
                    <Translate contentKey="akountsApp.bankProject.projectType">Project Type</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('initialValue')}>
                    <Translate contentKey="akountsApp.bankProject.initialValue">Initial Value</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('currentValue')}>
                    <Translate contentKey="akountsApp.bankProject.currentValue">Current Value</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                    <Translate contentKey="akountsApp.bankProject.mainAccountId">Main Account Id</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
                  ...
                  <tr key={`entity-${i}`} data-cy="entityTable">
                    ...
                    <td className="text-end">
                      <div className="btn-group flex-btn-group-container">
                        ...
                        <Button
                          tag={Link}
                          to={`${match.url}/${bankProject.id}/delete`}
                          color="danger"
                          size="sm"
