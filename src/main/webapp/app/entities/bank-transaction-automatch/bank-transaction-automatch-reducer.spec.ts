...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './bank-transaction-automatch.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BANKTRANSACTIONAUTOMATCH_LIST actions', async () => {
    ...
    it('dispatches FETCH_BANKTRANSACTIONAUTOMATCH actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BANKTRANSACTIONAUTOMATCH actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BANKTRANSACTIONAUTOMATCH actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BANKTRANSACTIONAUTOMATCH actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BANKTRANSACTIONAUTOMATCH actions', async () => {
      const expectedActions = [
        {
