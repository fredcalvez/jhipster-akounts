...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './bank-tag.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BANKTAG_LIST actions', async () => {
    ...
    it('dispatches FETCH_BANKTAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BANKTAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BANKTAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BANKTAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BANKTAG actions', async () => {
      const expectedActions = [
        {
