...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './automatch.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AUTOMATCH_LIST actions', async () => {
    ...
    it('dispatches FETCH_AUTOMATCH actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_AUTOMATCH actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_AUTOMATCH actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_AUTOMATCH actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_AUTOMATCH actions', async () => {
      const expectedActions = [
        {
