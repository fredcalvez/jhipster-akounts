...
import { getEntities } from './automatch.reducer';
        ...
        {automatchList && automatchList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="akountsApp.automatch.id">ID</Translate>
                </th>
                <th>
                ...
                <th>
                  <Translate contentKey="akountsApp.automatch.category">Category</Translate>
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {automatchList.map((automatch, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{automatch.updateTime ? <TextFormat type="date" value={automatch.updateTime} format={APP_DATE_FORMAT} /> : null}</td>
                  <td>
