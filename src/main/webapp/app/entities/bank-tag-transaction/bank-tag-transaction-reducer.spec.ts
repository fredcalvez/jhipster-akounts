...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './bank-tag-transaction.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BANKTAGTRANSACTION_LIST actions', async () => {
    ...
    it('dispatches FETCH_BANKTAGTRANSACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BANKTAGTRANSACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BANKTAGTRANSACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BANKTAGTRANSACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BANKTAGTRANSACTION actions', async () => {
      const expectedActions = [
        {
