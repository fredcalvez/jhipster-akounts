...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './transaction-duplicates.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRANSACTIONDUPLICATES_LIST actions', async () => {
    ...
    it('dispatches FETCH_TRANSACTIONDUPLICATES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TRANSACTIONDUPLICATES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TRANSACTIONDUPLICATES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TRANSACTIONDUPLICATES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TRANSACTIONDUPLICATES actions', async () => {
      const expectedActions = [
        {
