...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PLAIDITEM_LIST actions', async () => {
    ...
    it('dispatches FETCH_PLAIDITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PLAIDITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PLAIDITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PLAIDITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PLAIDITEM actions', async () => {
      const expectedActions = [
        {
