...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './bank-transaction-2.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BANKTRANSACTION2_LIST actions', async () => {
    ...
    it('dispatches FETCH_BANKTRANSACTION2 actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BANKTRANSACTION2 actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BANKTRANSACTION2 actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BANKTRANSACTION2 actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BANKTRANSACTION2 actions', async () => {
      const expectedActions = [
        {
