...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BANKINSTITUTION_LIST actions', async () => {
    ...
    it('dispatches FETCH_BANKINSTITUTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BANKINSTITUTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BANKINSTITUTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BANKINSTITUTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BANKINSTITUTION actions', async () => {
      const expectedActions = [
        {
