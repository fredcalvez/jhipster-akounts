...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AKOUNTSSETTINGS_LIST actions', async () => {
    ...
    it('dispatches FETCH_AKOUNTSSETTINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_AKOUNTSSETTINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_AKOUNTSSETTINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_AKOUNTSSETTINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_AKOUNTSSETTINGS actions', async () => {
      const expectedActions = [
        {
