  ...
  const defaultValues = () =>
    isNew
      ...
      : {
          ...
          category: bankTransactionEntity?.category?.id,
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                id="bank-transaction-category"
                name="category"
                data-cy="category"
                label={translate('akountsApp.bankTransaction.category')}
                type="select"
              >
                <option value="" key="0" />
                {bankCategories
              ...
              <ValidatedField
                ...
                name="account"
                data-cy="account"
                label={translate('akountsApp.bankTransaction.account')}
                type="select"
              >
                <option value="" key="0" />
                {bankAccounts
