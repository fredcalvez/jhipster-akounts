        ...
        <dl className="jh-entity-details">
          ...
          <dd>
            {bankTransactionEntity.transactionDate ? (
              <TextFormat value={bankTransactionEntity.transactionDate} type="date" format={APP_LOCAL_DATE_FORMAT} />
            ) : null}
          </dd>
          <dt>
            <span id="description">
          ...
          <dd>{bankTransactionEntity.tag}</dd>
          <dt>
            <span id="createdOn">
          ...
          <dd>
            {bankTransactionEntity.createdOn ? (
              <TextFormat value={bankTransactionEntity.createdOn} type="date" format={APP_DATE_FORMAT} />
            ) : null}
          </dd>
          <dt>
            <span id="updatedOn">
          ...
          <dd>
            {bankTransactionEntity.updatedOn ? (
              <TextFormat value={bankTransactionEntity.updatedOn} type="date" format={APP_DATE_FORMAT} />
            ) : null}
          </dd>
          <dt>
            <span id="version">
          ...
          <dd>{bankTransactionEntity.version}</dd>
          <dt>
