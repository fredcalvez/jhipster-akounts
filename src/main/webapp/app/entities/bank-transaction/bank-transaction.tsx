              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={sort('tag')}>
                    <Translate contentKey="akountsApp.bankTransaction.tag">Tag</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('createdOn')}>
                    <Translate contentKey="akountsApp.bankTransaction.createdOn">Created On</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('updatedOn')}>
                    <Translate contentKey="akountsApp.bankTransaction.updatedOn">Updated On</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('version')}>
                    <Translate contentKey="akountsApp.bankTransaction.version">Version</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
