...
export const getEntities = createAsyncThunk('bankTransaction/fetch_entity_list', async ({ page, size, sort }: IQueryParams) => {
...
export const createEntity = createAsyncThunk(
  ...
  async (entity: IBankTransaction, thunkAPI) => {
    return axios.post<IBankTransaction>(apiUrl, cleanEntity(entity));
  },
  { serializeError: serializeAxiosError }
);
...
export const updateEntity = createAsyncThunk(
  ...
  async (entity: IBankTransaction, thunkAPI) => {
    return axios.put<IBankTransaction>(`${apiUrl}/${entity.id}`, cleanEntity(entity));
  },
  { serializeError: serializeAxiosError }
);
...
export const partialUpdateEntity = createAsyncThunk(
  ...
  async (entity: IBankTransaction, thunkAPI) => {
    return axios.patch<IBankTransaction>(`${apiUrl}/${entity.id}`, cleanEntity(entity));
  },
  { serializeError: serializeAxiosError }
);
...
export const deleteEntity = createAsyncThunk(
  ...
  async (id: string | number, thunkAPI) => {
    const requestUrl = `${apiUrl}/${id}`;
    return await axios.delete<IBankTransaction>(requestUrl);
  },
  { serializeError: serializeAxiosError }
);
