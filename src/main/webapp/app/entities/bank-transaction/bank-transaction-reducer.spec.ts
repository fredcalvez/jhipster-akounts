...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BANKTRANSACTION_LIST actions', async () => {
    ...
    it('dispatches FETCH_BANKTRANSACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BANKTRANSACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BANKTRANSACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BANKTRANSACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BANKTRANSACTION actions', async () => {
      const expectedActions = [
        {
