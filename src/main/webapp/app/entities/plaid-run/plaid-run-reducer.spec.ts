...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './plaid-run.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PLAIDRUN_LIST actions', async () => {
    ...
    it('dispatches FETCH_PLAIDRUN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PLAIDRUN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PLAIDRUN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PLAIDRUN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PLAIDRUN actions', async () => {
      const expectedActions = [
        {
