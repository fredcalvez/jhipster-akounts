...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BANKSTREAM_LIST actions', async () => {
    ...
    it('dispatches FETCH_BANKSTREAM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BANKSTREAM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BANKSTREAM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BANKSTREAM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BANKSTREAM actions', async () => {
      const expectedActions = [
        {
