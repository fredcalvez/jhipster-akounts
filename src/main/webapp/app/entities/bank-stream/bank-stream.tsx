...
import { getEntities, reset } from './bank-stream.reducer';
...
export const BankStream = (props: RouteComponentProps<{ url: string }>) => {
  ...
  const totalItems = useAppSelector(state => state.bankStream.totalItems);
  const links = useAppSelector(state => state.bankStream.links);
  const entity = useAppSelector(state => state.bankStream.entity);
  ...
  return (
    <div>
      ...
      <div className="table-responsive">
        <InfiniteScroll
          dataLength={bankStreamList ? bankStreamList.length : 0}
          next={handleLoadMore}
              ...
              <thead>
                <tr>
                  <th className="hand" onClick={sort('id')}>
                    <Translate contentKey="akountsApp.bankStream.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('name')}>
                    <Translate contentKey="akountsApp.bankStream.name">Name</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('streamType')}>
                    <Translate contentKey="akountsApp.bankStream.streamType">Stream Type</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                    <Translate contentKey="akountsApp.bankStream.mainAccountId">Main Account Id</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
                  ...
                  <tr key={`entity-${i}`} data-cy="entityTable">
                    ...
                    <td className="text-end">
                      <div className="btn-group flex-btn-group-container">
                        ...
                        <Button
                          tag={Link}
                          to={`${match.url}/${bankStream.id}/delete`}
                          color="danger"
                          size="sm"
