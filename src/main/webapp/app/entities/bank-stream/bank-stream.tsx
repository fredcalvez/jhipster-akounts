          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="akountsApp.bankStream.mainAccountId">Main Account Id</Translate>
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {bankStreamList.map((bankStream, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    {bankStream.mainAccountId ? (
                      <Link to={`bank-account/${bankStream.mainAccountId.id}`}>{bankStream.mainAccountId.id}</Link>
                    ) : (
                      ''
                    )}
                  </td>
