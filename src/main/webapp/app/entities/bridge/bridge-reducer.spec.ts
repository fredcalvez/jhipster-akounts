...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './bridge.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BRIDGE_LIST actions', async () => {
    ...
    it('dispatches FETCH_BRIDGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BRIDGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BRIDGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BRIDGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BRIDGE actions', async () => {
      const expectedActions = [
        {
