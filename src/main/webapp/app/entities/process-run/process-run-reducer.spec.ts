...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROCESSRUN_LIST actions', async () => {
    ...
    it('dispatches FETCH_PROCESSRUN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PROCESSRUN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PROCESSRUN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PROCESSRUN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PROCESSRUN actions', async () => {
      const expectedActions = [
        {
