...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BANKSAVING_LIST actions', async () => {
    ...
    it('dispatches FETCH_BANKSAVING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BANKSAVING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BANKSAVING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BANKSAVING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BANKSAVING actions', async () => {
      const expectedActions = [
        {
