...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './plaid-configuration.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PLAIDCONFIGURATION_LIST actions', async () => {
    ...
    it('dispatches FETCH_PLAIDCONFIGURATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PLAIDCONFIGURATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PLAIDCONFIGURATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PLAIDCONFIGURATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PLAIDCONFIGURATION actions', async () => {
      const expectedActions = [
        {
