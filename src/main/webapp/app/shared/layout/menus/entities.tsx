...
export const EntitiesMenu = props => (
  ...
  >
    ...
    <MenuItem icon="asterisk" to="/plaid-account">
      <Translate contentKey="global.menu.entities.plaidAccount" />
    </MenuItem>
    <MenuItem icon="asterisk" to="/plaid-configuration">
      <Translate contentKey="global.menu.entities.plaidConfiguration" />
    </MenuItem>
    <MenuItem icon="asterisk" to="/plaid-item">
      <Translate contentKey="global.menu.entities.plaidItem" />
    </MenuItem>
    <MenuItem icon="asterisk" to="/plaid-run">
      <Translate contentKey="global.menu.entities.plaidRun" />
    </MenuItem>
    <MenuItem icon="asterisk" to="/plaid-transaction">
      <Translate contentKey="global.menu.entities.plaidTransaction" />
    </MenuItem>
    <MenuItem icon="asterisk" to="/process-run">
      <Translate contentKey="global.menu.entities.processRun" />
    </MenuItem>
    <MenuItem icon="asterisk" to="/text-cleaner">
      <Translate contentKey="global.menu.entities.textCleaner" />
    </MenuItem>
    <MenuItem icon="asterisk" to="/transaction-duplicates">
      <Translate contentKey="global.menu.entities.transactionDuplicates" />
    </MenuItem>
    <MenuItem icon="asterisk" to="/trigger-run">
      <Translate contentKey="global.menu.entities.triggerRun" />
    </MenuItem>
