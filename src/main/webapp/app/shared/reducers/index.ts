...
// prettier-ignore
import textCleaner from 'app/entities/text-cleaner/text-cleaner.reducer';
// prettier-ignore
import transactionDuplicates from 'app/entities/transaction-duplicates/transaction-duplicates.reducer';
// prettier-ignore
import triggerRun from 'app/entities/trigger-run/trigger-run.reducer';
